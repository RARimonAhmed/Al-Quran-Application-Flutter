...
class Gregorian {
  ...
  Gregorian.fromJson(Map<String, dynamic> json) {
    ...
    day = json['day'];
    weekday =
        json['weekday'] != null ? Weekdays.fromJson(json['weekday']) : null;
    month = json['month'] != null ? Months.fromJson(json['month']) : null;
    year = json['year'];
...
class Months {
  ...
  Months({this.number, this.en, this.ar});
